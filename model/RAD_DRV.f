...
#endif  /* TRACERS_BIOGENIC_BrC */
#endif  /* TRACERS_BrC */
#endif  /* TRACERS_AEROSOLS_VBS */
#ifdef TRACERS_AEROSOLS_SOA
#ifndef TRACERS_BIOGENIC_BrC
     &                            ,n_isopp1a
#endif
#endif  /* TRACERS_AEROSOLS_SOA */
     &                            ,n_BCIA,n_BCB/)
...
!     &       ,5,6/)
     ...
     &                             1.d0,1.d0
#ifdef TRACERS_BrC
     &                             ,1.0d0,1.0d0,1.0d0 !Enhance abs. here
#ifdef TRACERS_BIOGENIC_BrC
#ifdef TRACERS_AEROSOLS_SOA
#ifdef TRACERS_TERP
     &                             ,1.0d0,1.0d0 !Enhance abs. here
#endif  /* TRACERS_TERP */
     &                             ,1.0d0,1.0d0 !Enhance abs. here
#endif  /* TRACERS_AEROSOLS_SOA */
#endif  /* TRACERS_BIOGENIC_BrC */
...
C     OUTPUT DATA
     ...
     &          ,aesqex,aesqsc,aesqcb,aesasy,CO2outCol
...
#endif  /* TRACERS_AEROSOLS_VBS */
#ifdef TRACERS_AEROSOLS_SOA
#if (defined TRACERS_BrC) && (defined TRACERS_BIOGENIC_BrC)
#else
          case ("isopp1a")
...
#endif /* TRACERS_TERP */
     &                 )
#endif /* TRACERS_BrC/BIOGENIC_BrC */
#endif /* TRACERS_AEROSOLS_SOA */
          case ("BCIA")
     ...
     *      +frac_so4_has_nh4(1:lm)
     ...
     &        (sum(nintaersca(1:lm,kr,n))+1.d-10)
      ...
      if (nraero_aod>0) then
        ...
        scatau_as(i,j,1:LM,1:nraero_aod)=aesqsc(1:LM,6,1:nraero_aod)
        g_as(i,j,1:LM,1:nraero_aod)=aesasy(1:LM,6,1:nraero_aod)
        if (save_dry_aod>0) then
