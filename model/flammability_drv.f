...
!!    Attribution of biomass burning emissions to BrC:
      real*8:: OCB_BBfactor      
...
#ifdef TRACERS_BrC
      OCB_BBfactor=1.d0-BrC_wemifactBB
      if (OCB_BBfactor.lt.0.d0) then
        call stop_model
      end if
#endif /* TRACERS_BrC */
        ...
        case(1) ! GFED4s 2001-2009
          ...
          select case(trname(n))
            ...
            case('M_OCC_OC','OCB','BrC_w')
              ...
              select case(trname(n))
                case('BrC_w')
                  EPFCByVegType(:,n)=EPFCByVegType(:,n)*BrC_wemifactBB
                case('OCB')
                  EPFCByVegType(:,n)=EPFCByVegType(:,n)*OCB_BBfactor
              end select
#endif /* TRACERS_BrC */
            case('NOx') 
              do v=1,N_COVERTYPES
