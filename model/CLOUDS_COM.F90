...
!@param cld_plow low-level clouds in layers with mid-pt pressures >= cld_plow (mb)
  real*8, parameter :: cld_plow = 680.
!@param cld_pmid mid-level clouds in layers with mid-pt pressures >= cld_pmid (mb)
  real*8, parameter :: cld_pmid = 440.
