...
#ifdef TRACERS_BrC
integer, parameter                 :: imfbrc_t=12
integer, parameter                 :: imfbrc_w=13
integer, parameter                 :: imfbrc_b=14
!
!                                     ter     aro    isop    ocii    ocia     ocb   ococean   bcii    bcia    bcb    inorg  brc_t   brc_w   brc_b
data Lambda(imfapin,1:soacomp)    / 1.00d0, 1.00d0, 1.00d0, 0.80d0, 0.90d0, 0.85d0, 0.80d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, 0.85d0, 0.85d0, 0.85d0/
data Lambda(imfaro,1:soacomp)     /-1.00d0, 1.00d0, 1.00d0, 0.80d0, 0.90d0, 0.85d0, 0.80d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, 0.85d0, 0.85d0, 0.85d0/
data Lambda(imfisop,1:soacomp)    /-1.00d0,-1.00d0, 1.00d0, 0.80d0, 0.90d0, 0.85d0, 0.80d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, 0.85d0, 0.85d0, 0.85d0/
data Lambda(imfocii,1:soacomp)    /-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.90d0, 0.85d0, 0.80d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, 0.85d0, 0.85d0, 0.85d0/
data Lambda(imfocia,1:soacomp)    /-1.00d0,-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.85d0, 0.80d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, 0.85d0, 0.85d0, 0.85d0/
data Lambda(imfocb,1:soacomp)     /-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.80d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, 1.00d0, 1.00d0, 1.00d0/
data Lambda(imfococean,1:soacomp) /-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.90d0,-1.00d0, 1.00d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, -1.00d0, -1.00d0, -1.00d0/
data Lambda(imfbcii,1:soacomp)    /-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.80d0, 0.75d0, 0.70d0, -1.00d0, -1.00d0, -1.00d0/
data Lambda(imfbcia,1:soacomp)    /-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.75d0, 0.70d0, -1.00d0, -1.00d0, -1.00d0/
data Lambda(imfbcb,1:soacomp)     /-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.70d0, -1.00d0, -1.00d0, -1.00d0/
data Lambda(imfinorg,1:soacomp)   /-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0, 1.00d0, -1.00d0, -1.00d0, -1.00d0/
data Lambda(imfbrc_t,1:soacomp)   /-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.80d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, 1.00d0, 1.00d0, 1.00d0/
data Lambda(imfbrc_w,1:soacomp)   /-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.80d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, 1.00d0, 1.00d0, 1.00d0/
data Lambda(imfbrc_b,1:soacomp)   /-1.00d0,-1.00d0,-1.00d0,-1.00d0,-1.00d0, 1.00d0, 0.80d0, 0.70d0, 0.80d0, 0.75d0, 0.70d0, 1.00d0, 1.00d0, 1.00d0/
...
#ifdef TRACERS_BrC
  PCP=PCP+y_ug(n_brc_t)+y_ug(n_brc_w)+y_ug(n_brc_b)
#endif /* TRACERS_BrC */
...
#ifdef TRACERS_BrC
  AEROtot=AEROtot+y_mw(n_brc_t)+y_mw(n_brc_w)+y_mw(n_brc_b)
#endif /* TRACERS_BrC */
#endif /* TRACERS_AEROSOLS_VBS */
#ifdef TRACERS_AEROSOLS_OCEAN
...
#ifdef TRACERS_BrC
    xmf(imfbrc_t)=y_mw(n_brc_t)/AEROtot
    xmf(imfbrc_w)=y_mw(n_brc_w)/AEROtot
    xmf(imfbrc_b)=y_mw(n_brc_b)/AEROtot
#endif /* TRACERS_BrC */
#endif /* TRACERS_AEROSOLS_VBS */
#ifdef TRACERS_AEROSOLS_OCEAN
...
#ifdef TRACERS_BrC
    meanmw=meanmw+y_mw(n_brc_t)*mw(n_brc_t)/AEROtot
    meanmw=meanmw+y_mw(n_brc_w)*mw(n_brc_w)/AEROtot
    meanmw=meanmw+y_mw(n_brc_b)*mw(n_brc_b)/AEROtot
#endif /* TRACERS_BrC */
#endif /* TRACERS_AEROSOLS_VBS */
#ifdef TRACERS_AEROSOLS_OCEAN
