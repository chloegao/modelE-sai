...
C**** calculate mass of water needed to fill the swamp part (cylinder)
C**** area of the swamp = the area of cylindrical lake of depth minMLD
...
C**** assuming that all water forms a cylinder of height minMLD
              new_flake = mwtot/(RHOW*minMLD*AXYP(I,J))
            else
